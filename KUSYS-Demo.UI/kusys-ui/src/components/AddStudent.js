                                        ...
                                        <div className='card-body'>
                                            <form onSubmit={isEdit ? this.editUser.bind(this, dispatch, name, surName, identityNo, birthDate, id) : this.addUser.bind(this, dispatch, name, surName, identityNo, birthDate)}>
                                                ...
                                                <div className='form-group'>
                                                    ...
                                                    <input onChange={this.changeInput.bind(this, dispatch)} value={birthDate} type="text" name="birthDate" placeholder='Choose A Birth Day(dd/mm/yyyy)' className='form-control'></input>
                                                </div>
